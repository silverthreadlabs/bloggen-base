...
const aboutSchema: WithContext<WebPage> = {
  ...
  isPartOf: {
    ...
    image: {
      ...
      width: siteConfig
        .getImageConfig(`About | ${siteConfig.title}`)
        .width.toString(),
      height: siteConfig
        .getImageConfig(`About | ${siteConfig.title}`)
        .height.toString(),
      description: siteConfig.getImageConfig(`About | ${siteConfig.title}`)
        .description,
    },
  },
  mainEntity: [
    {
      ...
      description:
        'Built-in metadata, OG Images, sitemap & much more to keep your site optimized from day one.',
    },
    {
      '@type': 'CreativeWork',
      name: 'Designrift',
      description:
        'Create stunning themes for your web application with Radix color palettes for cohesive styling.',
    },
    {
      '@type': 'CreativeWork',
      name: 'MDX-Powered Blog',
      description:
        'Drop MDX files into your directory to publish SEO-friendly, responsive posts instantly.',
    },
    {
      '@type': 'CreativeWork',
    ...
    },
    {
      ...
      description:
        'Automatically generate RSS feed to keep subscribers updated in real time.',
    },
    {
      '@type': 'CreativeWork',
      name: 'SEO & Performance Analytics',
      description:
        'Built-in performance metrics with Google Analytics, Lighthouse, and more.',
    },
  ],
};
