  ...
  plugins: [
    ...
    anonymous({
      onLinkAccount: async ({ anonymousUser, newUser }) => {
        // When an anonymous user links their account, you can perform actions
        // like moving chat history, documents, etc. from anonymous to new user
        console.log('Anonymous user linked account:', {
          anonymousUser,
          newUser,
        });
      },
