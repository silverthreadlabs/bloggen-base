        ...
        <div className="mb-12 product-card-themed flex items-center justify-between pt-8">
          <div className="flex items-center gap-6">
            <div className="text-center">
              ...
              />
              <p className="text-canvas-text mt-3 text-sm font-medium capitalize">
                minimal
              </p>
            </div>
        ...
        >
          <div className="flex flex-col justify-between gap-4 p-6">
            ...
            <div className="flex items-start justify-between">
              <div>
                <h1 className="text-canvas-text-contrast mb-3 text-xl font-bold">
                  MacBook Pro 16"
                </h1>
            ...
            <div className="flex items-center gap-4">
              <span className="text-canvas-text-contrast text-xl font-bold">
                $2,399
              </span>
              <span className="text-canvas-text text-xl line-through">
                $2,799
              </span>
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              {sizes.map((size) => (
                <Button
                  ...
                  color={
                    selectedSize === size
                      ? `${currentTheme === 'minimal' ? 'neutral' : 'primary'}`
                      : 'neutral'
                  }
                  size="sm"
