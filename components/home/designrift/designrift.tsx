      ...
      <div className="mx-auto max-w-7xl py-10 xl:py-16">
        <div className="grid grid-cols-1 items-center lg:grid-cols-2">
          ...
          >
            ...
            >
              Designrift helps you create stunning, accessible themes using
              Radix colors. Get built-in dark mode and accessibility. Set up
              once, customize infinitely.
            </motion.p>
            ...
            >
              {[
                ...
                >
                  ...
                  <span className="text-canvas-text-contrast font-medium">
                    {feature}
                  </span>
                </motion.div>
              ))}
            ...
            >
              <Link href="https://designrift.vercel.app/" target="_blank">
                <Button
                  ...
                  variant="solid"
                  size="lg"
                  aria-label="Start Customizing Theme"
                >
