...
function FAQItemComponent({ item, isOpen, onToggle }: FAQItemComponentProps) {
  return (
    <li className="border-canvas-line hover:border-canvas-border-hover border-b transition-colors duration-300">
      {/* Question Button */}
      <button
        type="button"
...
export default function Faq() {
  ...
  return (
    <section
      className="py:10 w-full px-4 sm:px-6 lg:px-8 xl:py-16"
