...
const themes = {
  amber: {
    name: 'amber',
    cardBg:
      'bg-gradient-to-br from-orange-500/10 via-amber-500/5 to-yellow-500/10 backdrop-blur-xl',
    ...
    buttonSecondary:
      'bg-orange-500/20 hover:bg-orange-500/30 text-orange-600 border-orange-400/50',
    shadow: 'shadow-2xl shadow-orange-500/20',
    indicator: 'bg-gradient-to-br from-orange-400 to-amber-500',
    imageBg:
      'bg-gradient-to-br from-orange-500/20 via-amber-500/15 to-yellow-500/20',
  ...
  modern: {
    name: 'modern',
    cardBg:
      'bg-gradient-to-br from-green-500/10 via-emerald-500/5 to-teal-500/10 backdrop-blur-xl',
    ...
    buttonSecondary:
      'bg-green-500/20 hover:bg-green-500/30 text-green-600 border-green-400/50',
  ...
  minimal: {
    name: 'minimal',
    cardBg:
      'bg-gradient-to-br from-gray-900/80 via-black/60 to-gray-800/80 backdrop-blur-xl',
        ...
        <div className="flex items-center gap-6">
          {Object.entries(themes).map(([key, themeData]) => (
            <div key={key} className="text-center">
              ...
              <p className="mt-3 text-sm font-medium text-gray-400 capitalize">
                {themeData.name}
              </p>
            </div>
          ))}
        ...
        <div className="">
          ...
          <div className="flex flex-col justify-between gap-4 p-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className={`text-xl line-through ${theme.textSecondary}`}>
                $2,799
              </span>
            </div>
