  ...
  return (
    <div className="w-full min-h-screen max-w-7xl mx-auto space-y-8 py-10 sm:py-16">
      <div className="text-center space-y-4 mb-3">
        ...
        <p className="text-canvas-text  whitespace-pre-line">{description}</p>
      </div>
      ...
      <div className="flex justify-center mb-10">
        ...
        <span className="ml-2 font-semibold">
          Annual billing <span className="text-primary-text">(Save 20%)</span>
        </span>
      </div>
        ...
        {plans.map((plan, index) => (
          ...
          >
            ...
            <div className="flex-1 flex flex-col">
              <p className="text-base font-semibold text-canvas-text mt-2">
                {plan.name}
              </p>
              <div className="mt-6 flex items-center justify-center gap-x-2">
                <span className="text-5xl font-bold tracking-tight text-canvas-text">
                  <NumberFlow
                    value={
                ...
                {plan.period !== 'Next 3 months' && (
                  <span className="text-sm font-semibold leading-6 tracking-wide text-canvas-text">
                    / {plan.period}
                  </span>
                )}
              </div>

              <p className="text-xs leading-5 text-canvas-text">
              ...
              <ul className="mt-5 gap-2 flex flex-col">
                {plan.features.map((feature, idx) => (
                  <li key={idx} className="flex items-start gap-2">
                    <CheckIcon className="h-4 w-4 text-success-text mt-1 flex-shrink-0" />
              ...
              <p className="mt-6 text-xs leading-5 text-canvas-text">
                {plan.description}
              </p>
            </div>
          </motion.div>
