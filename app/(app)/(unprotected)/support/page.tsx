...
import { createPageMetadata } from '@/lib/seo/metadata/create-page-metadata';
import ContactSchema from '@/lib/seo/schema/support';
      ...
      <div className="mx-auto min-h-screen w-full max-w-7xl">
        <div className="px-4 py-16">
          ...
          <header className="mb-12 text-center">
            <h1 className="text-canvas-text-contrast mb-4 text-4xl font-bold md:text-5xl">
              Get in touch
            </h1>
            <h2 className="text-canvas-text mx-auto max-w-2xl text-lg text-balance">
              Book a meeting with us to discuss how we can help or fill out a
